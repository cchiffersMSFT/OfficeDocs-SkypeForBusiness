...
**What happens if I move a recording to another location in SharePoint/OneDrive?**
  
TMR expiration tags follows the recording. On the expiration date, the recording will be moved to the OneDrive or SharePoint recycle bim. Users can choose to download the recording if they wish to save it, or anyone who has edit and delete permissions can modify and extend the expiration date.
